  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-6 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4 animate-fade-in-slide-up" style={{ animationDelay: '0.2s' }}>
          PARE DE PERDER LUCRO. ASSUMA O CONTROLE TOTAL DAS SUAS ENTREGAS.
        </h1>
        <p className="text-lg md:text-xl mb-8 animate-fade-in-slide-up" style={{ animationDelay: '0.4s' }}>

  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-6 max-w-4xl mx-auto">
        <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-4 animate-fade-in-slide-up" style={{ animationDelay: '0.2s' }}>
          PARE DE PERDER LUCRO. ASSUMA O CONTROLE TOTAL DAS SUAS ENTREGAS.
        </h1>
        <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-8 animate-fade-in-slide-up" style={{ animationDelay: '0.4s' }}>
        ...
        <Button
          asChild
          className="bg-red-600 hover:bg-red-700 text-white text-base px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-6 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 animate-fade-in-slide-up animate-pulse-glow"
